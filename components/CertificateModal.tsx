  ...
  const loadEnrolledUsers = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const testEmails = ['rauf123@gmail.com', 'test1@example.com', 'test2@example.com', 'vusalguluyev153@gmail.com']
    ...
    try {
      ...
      for (let i = 0; i < completedUsers.length; i++) {
        ...
        try {
          ...
          formData.append('Name', userName) // Required by backend validation
          formData.append('Date', formattedDate) // Required by backend validation
